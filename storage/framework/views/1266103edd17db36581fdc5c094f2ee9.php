    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark nav_custom p-4">
                ...
                <div style="background-color:#301934"class="offcanvas offcanvas-start border-0  px-3" data-bs-scroll="true" tabindex="-1"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-block d-sm-none">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(route('comp.view')); ?>">Add
                                    Company</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="d-flex m-search gap-2 mt-md-0 mt-3">
                ...
                <button type="button" class="btn btn-danger"><a href="<?php echo e(route('delete.user')); ?>"
...
<?php /**PATH C:\xampp\htdocs\companyproject\resources\views/layouts/header.blade.php ENDPATH**/ ?>