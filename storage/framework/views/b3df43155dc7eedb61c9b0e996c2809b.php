...
<?php echo $__env->make('sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <button type="button" class="btn btn-primary mt-3"><a href="<?php echo e(route('user.all')); ?>" class="can_btn">Cancel</a> </button>
...
$(document).ready(function(){
  $("#viewbt").click(function(){
    $.ajax({url: "<?php echo e(route('view.comp')); ?>", success: function(result){
      $("#showbt").html(result);
    }});
  });
});
...
</html><?php /**PATH C:\xampp\htdocs\companyproject\resources\views/addcomp.blade.php ENDPATH**/ ?>